                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info btn-md" onClick="javascript:location.href='./logout.php';" >Back To Page</button>
...
<?php
 if($_SERVER['REQUEST_METHOD']=='POST' && $_REQUEST['username']!='') {
	...
	$result=mysql_query("select * from admin where username='".$_REQUEST['username']."' and password='".$_REQUEST['password']."' ");
	$data=mysql_fetch_array($result);
	if($data['username']!='' && $data['admin_id']!='')
	{
